    ...
    Protected.prototype = {
        ...
        messages: {
            ...
            en: {
                ...
                notzero: {
                    empty: 'Maak een keuze',
                    incorrect: 'Onjuiste waarde'
                },

                integer: {
                    empty: 'Voer een geheel getal in',
                    incorrect: 'Onjuiste geheel getalwaarde'
                },

                float: {
                    empty: 'Voer een float nummer in',
                    incorrect: 'Onjuiste float'
                },
                ...
                between: {
                    empty: 'Voer de tussen {0} - {1} in',
                    incorrect: 'Voer de tussen {0} - {1} in'
                },

                name: {
                    empty: 'Voer hier uw naam in',
                    incorrect: 'Onjuiste naam'
                },

                firstname: {
                    empty: 'Vul uw voornaam in',
                    incorrect: 'Onjuiste voornaam'
                },

                lastname: {
                    empty: 'Vul uw achternaam in',
                ...
                phone: {
                    empty: 'Vul je telefoonnummer in',
                    incorrect: 'Onjuist telefoonnummer'
                },

                email: {
                    empty: 'Vul je e-mailadres in',
                    incorrect: 'Onjuist e-mailadres'
                },

                length: {
                    empty: 'Voer minimaal {0} tekens en maximaal {1} in',
                    incorrect: 'Niet correct. Voer minimaal {0} tekens en maximaal {1}​in'
                },

                minlength: {
                    empty: 'Voer ten minste {0} tekens in',
                    incorrect: 'U heeft minder dan {0} tekens ingevoerd'
                },

                maxlength: {
                    empty: 'Voer maximaal {0} tekens in',
                    incorrect: 'U hebt meer dan {0} tekens ingevoerd'
                },

                maxfilesize: {
                    empty: 'De grootte van een of meer geselecteerde bestanden groter dan {0} {1}',
                    incorrect: 'De grootte van een of meer geselecteerde bestanden groter dan {0} {1}'
                },

                fileextension: {
                    empty: 'Selecteer bestand',
        ...
        rules: {
            ...
            name: function (value) {
                ...
                return new RegExp(/^[a-zA-Z\sàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]+$/g).test(value);
            },
